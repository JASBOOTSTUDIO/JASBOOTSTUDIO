...
<p align="center">
  ...
  🧠 Lenguaje con memoria neuronal (JMN) · ⚙️ Máquina virtual · 📦 IR binario (<code>.jbo</code>)
</p>
...
2. ▶️ **Ejecutar** con **`jasboot-ir-vm`**, que interpreta el IR y enlaza la JMN y el resto del runtime.
...
| **[`docs/tecnico/`](docs/tecnico/)** 🖥️ | VM, formato JMN, grafo **n_**, NGF, FFI, heap, evaluación de capacidades para drivers y gráficos 3D. |
| **[`docs/proyecto/`](docs/proyecto/)** 🗂️ | Estado del árbol de desarrollo, visión de capas hacia OS-IA, contratos de runtime, catálogo de errores, guías puntuales. |
...
### 🖥️ Técnico (VM, formatos, compilador)
...
| ⚙️ Toolchain C (jbc, VM, JMN) | [github.com/JASBOOTSTUDIOS/sdk-dependiente](https://github.com/JASBOOTSTUDIOS/sdk-dependiente) |
